...
class CVActionType(Base):
    __tablename__ = 'dadosodm2_actiontype'
...
class CVAggregationStatistic(Base):
    __tablename__ = 'dadosodm2_cvaggregationstatistic'
    __table_args__ = {u'schema': 'odm2'}
...
class CVAnnotationType(Base):
    __tablename__ = 'dadosodm2_cvannotationtype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVCensorCode(Base):
    __tablename__ = 'dadosodm2_cvcensorcode'
    __table_args__ = {u'schema': 'odm2'}
...
class CVDatasetType(Base):
    __tablename__ = 'dadosodm2_cvdatasettype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVDataQualityType(Base):
    __tablename__ = 'dadosodm2_cvdataqualitytype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVDirectiveType(Base):
    __tablename__ = 'dadosodm2_cvdirectivetype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVElevationDatum(Base):
    __tablename__ = 'dadosodm2_cvelevationdatum'
    __table_args__ = {u'schema': 'odm2'}
...
class CVEquipmentType(Base):
    __tablename__ = 'dadosodm2_cvequipmenttype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVMediumType(Base):
    __tablename__ = 'dadosodm2_cvmedium'
    __table_args__ = {u'schema': 'odm2'}
...
class CVMethodType(Base):
    __tablename__ = 'dadosodm2_cvmethodtype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVOrganizationType(Base):
    __tablename__ = 'dadosodm2_cvorganizationtype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVPropertyDataType(Base):
    __tablename__ = 'dadosodm2_cvpropertydatatype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVQualityCode(Base):
     __tablename__ = 'dadosodm2_cvqualitycode'
     __table_args__ = {u'schema': 'odm2'}
...
class CVRelationshipType(Base):
    __tablename__ = 'dadosodm2_cvrelationshiptype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVResultType(Base):
    __tablename__ = 'dadosodm2_cvresulttype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSamplingFeatureGeoType(Base):
    __tablename__ = 'dadosodm2_cvsamplingfeaturegeotype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSamplingFeatureType(Base):
    __tablename__ = 'dadosodm2_cvsamplingfeaturetype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSpatialOffsetType(Base):
    __tablename__ = 'dadosodm2_cvspatialoffsettype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSpeciation(Base):
    __tablename__ = 'dadosodm2_cvspeciation'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSpecimenType(Base):
    __tablename__ = 'dadosodm2_cvspecimentype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVSiteType(Base):
    __tablename__ = 'dadosodm2_cvsitetype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVStatus(Base):
    __tablename__ = 'dadosodm2_cvstatus'
    __table_args__ = {u'schema': 'odm2'}
...
class CVTaxonomicClassifierType(Base):
    __tablename__ = 'dadosodm2_cvtaxonomicclassifiertype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVUnitsType(Base):
    __tablename__ = 'dadosodm2_cvunitstype'
    __table_args__ = {u'schema': 'odm2'}
...
class CVVariableName(Base):
    __tablename__ = 'dadosodm2_cvvariablename'
    __table_args__ = {u'schema': 'odm2'}
...
class CVVariableType(Base):
    __tablename__ = 'dadosodm2_cvvariabletype'
    __table_args__ = {u'schema': 'odm2'}
